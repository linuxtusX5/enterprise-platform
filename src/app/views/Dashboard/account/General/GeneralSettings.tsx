  ...
  return (
    <Formik
      ...
      onSubmit={async (values, formikHelpers) => {
        try {
          await dispatch(putProfileAction(values)); // Ensure async action completes
              ...
              <Grid container spacing={4}>
                ...
                <Grid item md={6} xs={12}>
                  <Autocomplete
                    ...
                    value={
                      countries.find(c => c.text === values.country) || null
                    }
                    onChange={(_, newValue) => {
                      setFieldValue('country', newValue?.text || '');
                    }}
                    renderInput={params => (
                      <TextField
                        {...params}
                ...
                <Grid item md={6} xs={12}>
                  ...
                  <Switch
                    checked={values.canHire || false}
                    name="canHire"
                    onChange={e => setFieldValue('canHire', e.target.checked)}
                  />
                </Grid>
              </Grid>
              {error && (
